...
from clearcode.context.indexers.code_parser import parse_file, get_source_files
...
def _embed_file(collection: chromadb.Collection, filepath: str, mtime: float, embedder=None) -> int:
   """
...
def index_codebase(repo_path: str) -> chromadb.Collection:
   ...
   for filepath, mtime in current_files.items():
       ...
       _embed_file(collection, filepath, mtime, embedder)
