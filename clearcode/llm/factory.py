...
def get_llm():
  ...
  raise ValueError(f"Unknown LLM provider '{provider}'. Expected 'openai' or 'anthropic'.")
...
def get_embedder():
  ...
  raise ValueError(f"Unknown embeddings provider '{provider}'. Expected 'openai' or 'huggingface'.")
